    ...
    <div
        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="links mt-8">
                ...
                <form id="searchForm">
                    <div class="mt-2">
                        <input type="text" name="word" placeholder="検索キーワード">
                    </div>
                    ...
                    <button type="submit" class="mt-4">検索</button>
                </form>

                <div id="table2" class="mt-8">
                    <table class="table table-striped home" id="table3">
                        <thead>
                            <tr>
                                <th>ID</th>
                                <th>商品画像</th>
                                <th>商品名</th>
                                <th id="priceHeader" style="cursor: pointer;">価格</th>
                                <th>在庫数</th>
                                <th>メーカー名</th>
                                <th>詳細</th>
                                <th>削除</th>
                        ...
                        <tbody id="productList">
                            @foreach ($products as $product)
                                <tr>
                                    ...
                                    <td>
                                        @if ($product->img_path)
                                            <img src="{{ asset($product->img_path) }}" width="80">
                                        @else
                                            画像なし
                                        @endif
                                    </td>
                                    <td>{{ $product->product_name }}</td>
                                    <td class="price-cell" data-price="{{ $product->price }}">{{ $product->price }}
                                    </td>
                                    <td>{{ $product->stock }}</td>
                                    <td>{{ $product->company->company_name }}</td>
                                    <td><a href="{{ route('show', ['id' => $product->id]) }}" class="underline">詳細</a>
                                    </td>
                                    <td>
